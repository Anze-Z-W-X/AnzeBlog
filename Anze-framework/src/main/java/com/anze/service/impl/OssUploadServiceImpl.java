...
import com.anze.utils.PathUtils;
...
public class OssUploadServiceImpl implements UploadService {
    ...
    public ResponseResult uploadimg(MultipartFile img) {
        ...
        //对原始文件名进行判断
        if(!(originalFilename.endsWith(".png")|originalFilename.endsWith(".jpg")))throw new SystemException(AppHttpCodeEnum.FILE_TYPE_ERROR);
        //如果判断通过上传文件到OSS
