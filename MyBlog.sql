/*
 ...
 Date: 05/08/2023 13:37:36
*/
CREATE DATABASE /*!32312 IF NOT EXISTS*/`az_blog` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `az_blog`;

DROP TABLE IF EXISTS `az_article`;

CREATE TABLE `az_article` (
  `id` bigint(200) NOT NULL AUTO_INCREMENT COMMENT '文章id',
